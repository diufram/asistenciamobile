...
class AsistenciaTallerScreen extends GetView<AsistenciaController> {
  const AsistenciaTallerScreen({super.key});

  void solicitudAsistencia() async {
    Get.toNamed(AsistenciaRoutes.asistenciacreate);
  }
                      ...
                      itemBuilder: ((context, index) {
                        ...
                        return ListTile(
                          title: GestureDetector(
                            onTap: () {
                              Get.toNamed(
                                  AsistenciaRoutes.asistenciatitletaller,
